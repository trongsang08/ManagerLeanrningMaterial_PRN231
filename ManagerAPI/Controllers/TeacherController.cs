...
namespace ManagerAPI.Controllers
{
    ...
    public class TeacherController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<AssignmentDto>> ListAssignmentByCourse(int teacherId, int courseId)
        => _assignmentRespository.ListAssignmentByTeacherAndCourse(teacherId, courseId).Select(_mapper.Map<Assignment, AssignmentDto>).ToList();
